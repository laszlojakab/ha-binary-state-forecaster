...
# Persistence
CONF_BASE_PERSISTENCE_STRENGTH: Final = "base_persistence_strength"
CONF_BASE_PERSISTENCE_STRENGTH_MIN: Final = 0.0
CONF_BASE_PERSISTENCE_STRENGTH_MAX: Final = 1.0
...
PRESET_CONFIGURATIONS = {
    PRESET_STABLE: {
        ...
        CONF_BASE_PERSISTENCE_STRENGTH: 0.7,
    ...
    PRESET_MODERATE: {
        ...
        CONF_BASE_PERSISTENCE_STRENGTH: 0.5,
    ...
    PRESET_DYNAMIC: {
        ...
        CONF_BASE_PERSISTENCE_STRENGTH: 0.3,
