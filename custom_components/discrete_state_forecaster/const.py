...
CONF_ADAPTIVE_HALF_LIFE: Final = "adaptive_half_life"
...
# Persistence
CONF_BASE_STATE_RETENTION_STRENGTH: Final = "base_state_retention_strength"
CONF_BASE_STATE_RETENTION_STRENGTH_MIN: Final = 0.0
CONF_BASE_STATE_RETENTION_STRENGTH_MAX: Final = 1.0
...
PRESET_CONFIGURATIONS = {
    PRESET_STABLE: {
        ...
        CONF_BASE_STATE_RETENTION_STRENGTH: 0.7,
    ...
    PRESET_MODERATE: {
        ...
        CONF_BASE_STATE_RETENTION_STRENGTH: 0.5,
    ...
    PRESET_DYNAMIC: {
        ...
        CONF_BASE_STATE_RETENTION_STRENGTH: 0.3,
