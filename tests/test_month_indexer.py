...
class TestMonthIndexerKey:
    ...
    def test_key_same_month_different_years(self) -> None:
        ...
        assert indexer.key(jan1) == indexer.key(jan2) == indexer.key(jan3) == 1

    def test_key_ignores_day_and_time(self) -> None:
        ...
        assert indexer.key(ts1) == indexer.key(ts2) == indexer.key(ts3) == 6

    def test_key_full_year_sequence(self) -> None:
    ...
    def test_key_leap_year_february(self) -> None:
...
class TestMonthIndexerNextBoundary:
    ...
    def test_next_boundary_january_to_february(self) -> None:
    ...
    def test_next_boundary_february_to_march(self) -> None:
    ...
    def test_next_boundary_leap_year_february(self) -> None:
    ...
    def test_next_boundary_december_to_january(self) -> None:
    ...
    def test_next_boundary_first_day_of_month(self) -> None:
    ...
    def test_next_boundary_last_day_of_month(self) -> None:
    ...
    def test_next_boundary_31_day_month_to_30_day_month(self) -> None:
    ...
    def test_next_boundary_30_day_month_to_31_day_month(self) -> None:
    ...
    def test_next_boundary_always_first_of_month(self) -> None:
    ...
    def test_next_boundary_year_end_sequence(self) -> None:
...
class TestMonthIndexerEdgeCases:
    ...
    def test_same_date_different_years(self) -> None:
        ...
        assert indexer.key(ts_2024) == 6
        assert indexer.key(ts_2025) == 6
        assert indexer.key(ts_2026) == 6

    def test_december_boundary_increments_year(self) -> None:
    ...
    def test_all_months_have_unique_keys(self) -> None:
    ...
    def test_multiple_year_transitions(self) -> None:
